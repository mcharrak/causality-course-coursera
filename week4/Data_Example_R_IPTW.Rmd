---
title: "Data Example R - Fitting a marginal structural model (MSM) using inverse probability of treatment weighting (IPTW) - Week 4"
output: html_notebook
---

# dataset: right heart catherizaiton (RHC), treatemnt: RHC treatment (yes/no), outcome: death (yes/no), confounders: demographics, insurance, disease diagnoses, etc., #treated 2184, #control 3551.
...
cat("\nThe 95% CI for each coefficient:\n")
confint(msm_trunc)
```
